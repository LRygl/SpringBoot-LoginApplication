...
public class FileConstant {
    ...
    public static final String APPLICATION_ROOT_PATH = "/nexus";
    public static final String USER_FOLDER = System.getProperty("user.home") + APPLICATION_ROOT_PATH + "/user/";
    public static final String COURSE_FOLDER = System.getProperty("user.home") + APPLICATION_ROOT_PATH + "/courses/";
    public static final String LESSON_FOLDER = System.getProperty("user.home") + APPLICATION_ROOT_PATH + "/lessons/";
    ...
    public static final String TEMP_PROFILE_IMAGE_BASE_URL = "https://ui-avatars.com/api/?";
    public static final String TEMP_IMAGE_FORMAT = "format=png";
    public static final String TEMP_IMAGE_ROUNDED = "rounded=true";
