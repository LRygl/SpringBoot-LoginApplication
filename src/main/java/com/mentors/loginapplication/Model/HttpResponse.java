...
public class HttpResponse {
    ...
    public HttpResponse(Date httpTimestamp, int httpStatusCode, HttpStatus httpStatus, String httpStatusReason, String httpStatusMessage, String httpDeveloperMessage, String httpPath, Map<?, ?> httpResponseData) {
